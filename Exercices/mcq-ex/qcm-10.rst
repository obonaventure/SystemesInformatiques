...
Un signal est dit synchrone lorsqu'il est causé par l'exécution d'une instruction du processus. Un signal est dit asynchrone s'il n'a pas été causé directement par l'exécution d'un instruction du processus. Parmi les affirmations suivantes, lesquelles sont correctes ?
...
.. question:: signal_stop_process
   ...
   .. negative::
      ...
      .. class:: comment
         ...
         C'est un signal SIGINT qui est envoyé au processus en cours d'exécution.
   ...
   .. negative::
      ...
      .. class:: comment
         ...
         Un processus ne peut pas prévoir de routine de traitement pour SIGKILL ni choisir d'ignorer ce type de signal.
...
.. question:: signal_handlers
   ...
   .. positive::
      ...
      .. class:: comment
         ...
         Avec sig_atomic_t, le compilateur garantit que tous les accès à la variable se feront de façon atomique.
...
Deux stratégies existent pour implémenter les signaux sous Unix: maintenir une queue de tous les signaux destinés à un processus donné ou représenter l'ensemble des signaux qu'un processus peut recevoir sous la forme de drapeaux binaires (un par signal). Linux utilise la seconde stratégie. Parmi les affirmations suivantes, lesquelles sont correctes ?
...
.. question:: signal_implementation_strategies
   ...
   .. positive::
      ...
      .. class:: comment
         ...
         C'est une question de compromis. La solution sous forme de drapeaux binaires est plus économe en mémoire mais n'est pas fiable.
   ...
   .. negative::
      ...
      .. class:: comment
         ...
         C'est une question de compromis. La solution utilisant une queue peut devenir très gourmande en mémoire s'il n'y a pas de limite sur la taille de la queue.
   ...
   .. negative::
      ...
      .. class:: comment
         ...
         Si le signal est envoyé 2 fois au processus avant l'exécution de la prochaine routine de traitement de signal, le drapeau sera mis à vrai et la routine de traitement de signal ne sera appelée qu'une seule fois.
