...
#. Ecrivez un code qui permet de récupérer un tableau d'entiers d'un thread. Exercice disponible sur `pythia <http://pythia.info.ucl.ac.be/module/13/problem/41>`_.
...
#. Résolvez des sudokus. Exercice disponible sur `pythia <http://pythia.info.ucl.ac.be/module/13/problem/42>`_.
